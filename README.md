...
You can then execute your native executable with: `./target/quarkus-cloudfunction-1.0-SNAPSHOT-runner`
...
Three examples have been generated under `src/main/java/org/acme/googlecloudfunctions`, you must remove them before
deploying to
Google Cloud Functions or setup multi-functions support,
see <https://quarkus.io/guides/gcp-functions#choose-your-function>.
